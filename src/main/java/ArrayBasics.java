...
public class ArrayBasics {
    ...
    public static void main(String[] args){
        ...
        System.out.println(a.getLengthOfArray(arr));
        System.out.println(a.getNthElementOfArray(arr,2));
        a.setNthElementOfArray(arr,2,7);
        System.out.println(a.returnNewArraySizeN(2));
